# -*- coding: utf-8 -*-
"""
Created on Fri Apr 14 12:03:32 2017
...
subsetNormalsList = []
for k in range(len(normalsList)):
    if idx[k]==True:
        subsetNormalsList.append(normalsList[k])
        
subsetNormalPointsList = []
for k in range(subsetNormalPoints.shape[0]):
...
thresh_point2plane = 10 # mm
thresh_dist_division_factor = 10
